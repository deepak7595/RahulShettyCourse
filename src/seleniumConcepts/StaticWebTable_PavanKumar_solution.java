...
public class StaticWebTable_PavanKumar_solution {
	...
	public static void main(String[] args) {
		...
		// String
		// bookName=driver.findElement(By.xpath("//table[@name='BookTable']//tr[5]//td[1]")).getText();
		 ...
		 * "]//td[1]")).getText(); System.out.println(bookName+"\t"+authorName); }
		 * 
		 * }
		 */
